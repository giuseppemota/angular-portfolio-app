export class Tag {
  static readonly CSHARP = new Tag("C#", "#5a7581");
  static readonly DOTNET = new Tag(".NET", "#5a7581");
  static readonly ENTITYFRAMEWORK = new Tag("Entity Framework", "#5a7581");
  static readonly INDENTITY = new Tag("Identity Framework", "#5a7581");
  ...
  static readonly PRIMENG = new Tag("PrimeNG", "#192129");
